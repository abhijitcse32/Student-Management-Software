						...
						<div class="box-body">
							 ...
							 <table border="1" width="100%" cellpadding="1" cellspacing="1" style="margin-top:10px">
								<tr style="color:#000000;">
									...
									<td width="" style="text-align:center"><b>Subject ID</b></td>
								...
								<tr>
									...
									<!--<td width="5%" bgcolor="<?php echo $bgcol;?>" align="center"><a href='<?php echo "?Basic=FacultyListView&faculty=".base64_encode($oResult->rows[$i]['id'])?>' style="color:black">VIEW</a> </td> -->
