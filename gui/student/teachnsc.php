					...
					<div class="col-md-6">
					  ...
					  <div class="box box-info">
						<div class="box-header with-border">
						  <h3 class="box-title">Teacher Notice</h3>
						</div>
						...
						<div class="box-body" style="height:322px; overflow-y:scroll;">
							 ...
							 <table border="1" width="100%" cellpadding="1" cellspacing="1" style="margin-top:10px">
								<tr style="color:#000000;">
									<td width="" style="text-align:center"><b>Notice Name</b></td>
								...
								<?php
									$sql="SELECT A.id, A.notice_name, A.batch_name, A.CreateBy, C.fname, C.lname, A.CreateDate
									FROM teacher_notice A, student B, faculty C
								...
								<tr>
									...
									<td width="5%" bgcolor="<?php echo $bgcol;?>" align="center"><a href='<?php echo "?Basic=TeacherNoticeView&teacher_notice=".base64_encode($oResult->rows[$i]['id'])?>' style="color:black">VIEW</a>  
