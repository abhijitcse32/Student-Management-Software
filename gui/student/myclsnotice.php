					...
					<div class="col-md-6">
					  ...
					  <div class="box box-info">
						<div class="box-header with-border">
						  <h3 class="box-title">My Classmate Notice</h3>
						</div>
						...
						<div class="box-body" style="height:322px; overflow-y:scroll;">
							 ...
							 <table border="1" width="100%" cellpadding="1" cellspacing="1" style="margin-top:10px">
								...
								<tr>
									...
									<td width="5%" bgcolor="<?php echo $bgcol;?>" align="center"><a href='<?php echo "?Basic=MyClsNtscView&std_notice=".base64_encode($oResult->rows[$i]['id'])?>' style="color:black">VIEW</a>  </td>
								</tr>
								<?php
										}
									}
