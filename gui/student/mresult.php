					...
					<div class="col-md-6">
					  ...
					  <div class="box box-info">
						<div class="box-header with-border">
						  <h3 class="box-title">All Trimister</h3>
						</div>
						...
						<div class="box-body">
							 ...
							 <table border="1" width="100%" cellpadding="1" cellspacing="1" style="margin-top:10px">
								...
								<tr>
									...
									<td width="5%" bgcolor="<?php echo $bgcol;?>" align="center"><a href='<?php echo "?Basic=AllResultView&trimister=".base64_encode($oResult->rows[$i]['id'])?>'><i class="glyphicon glyphicon-edit" style="color:black" title="View"></i></a>  
								</tr>
								<?php
										}
									}
