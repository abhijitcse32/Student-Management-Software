						...
						<div class="box-body">
							 ...
							 <table border="1" width="100%" cellpadding="1" cellspacing="1" style="margin-top:10px">
								...
								<tr>
									...
									<td width="5%" bgcolor="<?php echo $bgcol;?>" align="center"><a href='<?php echo "?Basic=AllResTriFullVW&batch=".base64_encode($oResult->rows[$i]['id'])?>' style="color:black">View</a>  
								</tr>
								<?php
										}
									}
