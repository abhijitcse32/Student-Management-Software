...
<div class="login">
	...
	<ul class="menu">
		<li><a href="index.php?Basic=profile">My Profile</a></li>
		<li><a href="index.php?Basic=AllNotice">All Notice</a></li>
		<li><a href="index.php?Basic=TeacherNotice">Teacher Notice</a></li>
		<li><a href="index.php?Basic=TeacherIndNotice">Teacher Individual Notice</a></li>
		<li><a href="index.php?Basic=TeacherInfo">Teacher Information</a></li>
		<li><a href="index.php?Basic=MRtn">My Routine</a></li>
		<li><a href="index.php?Basic=MyResult">My Result</a></li>
		<li><a href="index.php?Basic=MyFullResult">My Full Result</a></li>
